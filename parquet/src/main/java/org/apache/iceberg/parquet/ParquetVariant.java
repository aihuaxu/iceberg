...
public class ParquetVariant implements VariantLike {
  ...
  @Override
  public int size() {
    return internalVariant.objectSize();
  }

  @Override
  public ParquetVariant getFieldByKey(String key) {
    return new ParquetVariant(internalVariant.getFieldByKey(key));
  }

  @Override
  public ParquetVariant getFieldAtIndex(int index) {
    return new ParquetVariant(internalVariant.getElementAtIndex(index));
  }

  @Override
  public boolean getBoolean() {
    return internalVariant.getBoolean();
  }

  @Override
  public long getLong() {
    return internalVariant.getLong();
  }

  @Override
  public float getFloat() {
    return internalVariant.getFloat();
  }

  @Override
  public double getDouble() {
    return internalVariant.getDouble();
  }

  @Override
  public BigDecimal getDecimal() {
    return internalVariant.getDecimal();
  }

  @Override
  public String getString() {
    return internalVariant.getString();
  }

  @Override
  public byte[] getBinary() {
    return internalVariant.getBinary();
  }
